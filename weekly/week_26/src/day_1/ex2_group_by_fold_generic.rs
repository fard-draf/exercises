...
mod tests {
    ...
    fn test_group_by_country() {
        let cities = vec![
            City { name: "Paris".to_string(), country: "France".to_string() },
            City { name: "Lyon".to_string(), country: "France".to_string() },
            City { name: "Berlin".to_string(), country: "Germany".to_string() },
            City { name: "Quimper".to_string(), country: "France".to_string() }, // Note: not sorted
        ];
    ...
    fn test_single_element() {
        let cities = vec![City { name: "Tokyo".to_string(), country: "Japan".to_string() }];
        let grouped = group_by_key(cities.into_iter(), |c| c.country.clone());
    ...
    fn test_all_same_key() {
        let cities = vec![
            City { name: "Paris".to_string(), country: "France".to_string() },
            City { name: "Lyon".to_string(), country: "France".to_string() },
            City { name: "Marseille".to_string(), country: "France".to_string() },
        ];
        let grouped = group_by_key(cities.into_iter(), |c| c.country.clone());
        assert_eq!(grouped.len(), 1);
        assert_eq!(grouped[0].0, "France");
