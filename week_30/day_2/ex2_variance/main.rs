...
fn main() {
    ...
    // ----- Bloc de code avec une lifetime plus courte, 'a -----
    {
        ...
        let cov_a: Covariant<'_> = Covariant {
            data: lifetime_a_str,
        };
        ...
        let mut contra_static: Contravariant<'static> = Contravariant {
            _marker: PhantomData,
        };
        let mut contra_a: Contravariant<'_> = Contravariant {
            _marker: PhantomData,
        };
        ...
        let mut inv_static: Invariant<'static> = Invariant {
            _marker: PhantomData,
        };
        let inv_a: Invariant<'_> = Invariant {
            _marker: PhantomData,
        };
